...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_B] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_R] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_M] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_H] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_P] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_FAIRY] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_DRAGON] = false;
	matrix[COLLIDER_WALL][COLLIDER_POWERUP_MEDAL] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_POWERUP_FAIRY] = true;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_POWERUP_FAIRY] = false;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_POWERUP_FAIRY] = false;
	...
	matrix[COLLIDER_PLAYER2][COLLIDER_POWERUP_H] = true;
	matrix[COLLIDER_PLAYER2][COLLIDER_POWERUP_P] = true;
	matrix[COLLIDER_PLAYER2][COLLIDER_POWERUP_FAIRY] = true;
	...
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_POWERUP_FAIRY] = false;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_POWERUP_FAIRY] = false;
	...
	matrix[COLLIDER_EXPLOSION][COLLIDER_POWERUP_H] = false;
	matrix[COLLIDER_EXPLOSION][COLLIDER_POWERUP_P] = false;
	matrix[COLLIDER_EXPLOSION][COLLIDER_POWERUP_FAIRY] = false;
	matrix[COLLIDER_EXPLOSION][COLLIDER_POWERUP_DRAGON] = false;
	matrix[COLLIDER_EXPLOSION][COLLIDER_POWERUP_MEDAL] = false;

	

	matrix[COLLIDER_POWERUP_B][COLLIDER_WALL] = false;	 //POWER UP COLLIDERS
	...
	matrix[COLLIDER_POWERUP_R][COLLIDER_WALL] = false;        
	...
	matrix[COLLIDER_POWERUP_M][COLLIDER_WALL] = false;
	...
	matrix[COLLIDER_POWERUP_H][COLLIDER_EXPLOSION] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_PLAYER2] = true;
	matrix[COLLIDER_POWERUP_H][COLLIDER_PLAYER2_SHOT] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_B] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_R] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_M] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_H] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_P] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_FAIRY] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_DRAGON] = false;
	matrix[COLLIDER_POWERUP_H][COLLIDER_POWERUP_MEDAL] = false;
	

	matrix[COLLIDER_POWERUP_P][COLLIDER_WALL] = false;
	...
	matrix[COLLIDER_POWERUP_P][COLLIDER_POWERUP_H] = false;
	matrix[COLLIDER_POWERUP_P][COLLIDER_POWERUP_P] = false;
	matrix[COLLIDER_POWERUP_P][COLLIDER_POWERUP_FAIRY] = false;
	matrix[COLLIDER_POWERUP_P][COLLIDER_POWERUP_DRAGON] = false;
	matrix[COLLIDER_POWERUP_P][COLLIDER_POWERUP_MEDAL] = false;
	

	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_WALL] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_ENEMY_SHOT] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_EXPLOSION] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_PLAYER2] = true;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_PLAYER2_SHOT] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_B] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_R] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_M] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_H] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_P] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_FAIRY] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_DRAGON] = false;
	matrix[COLLIDER_POWERUP_FAIRY][COLLIDER_POWERUP_MEDAL] = false;


	matrix[COLLIDER_POWERUP_DRAGON][COLLIDER_WALL] = false;
	...
	matrix[COLLIDER_POWERUP_MEDAL][COLLIDER_POWERUP_H] = false;
	matrix[COLLIDER_POWERUP_MEDAL][COLLIDER_POWERUP_P] = false;
	matrix[COLLIDER_POWERUP_MEDAL][COLLIDER_POWERUP_FAIRY] = false;
...
void ModuleCollision::DebugDraw()
{
	...
	for (uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		case COLLIDER_POWERUP_M: // black
			App->render->DrawQuad(colliders[i]->rect, 0, 0, 0, alpha);
			break;
		case COLLIDER_POWERUP_H: // black
			App->render->DrawQuad(colliders[i]->rect, 0, 0, 0, alpha);
			break;
		case COLLIDER_POWERUP_P: // black
			App->render->DrawQuad(colliders[i]->rect, 0, 0, 0, alpha);
			break;
		case COLLIDER_POWERUP_FAIRY: // black
			App->render->DrawQuad(colliders[i]->rect, 0, 0, 0, alpha);
			break;
